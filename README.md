...
| `docs/RUN_EXPERIMENT.md` | Как поставить эксперимент: запуск OE + плагин, угловой триггер, правила валидности, запись, проверка TTL. |
...
| `docs/DEVELOPMENT_REPORT_2026-06-22.docx` | Журнал разработки по дням (реальные даты из git + история). |
