...
- Класс `StreamingPhasePercent` живёт в тестовом скрипте, в боевой мост
  (`single_rt_dlc_live_bridge.py`) не перенесён.
...
22 теста. Данные синтетические, GPU и записи не нужны, прогон около 7 секунд.
